...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence in self.knowledge:
            if sentence.count == 0:
                newSafes.update(sentence.cells)
            elif sentence.count == len(sentence.cells):
                newMines.update(sentence.cells)
        ...
        # Adding new sentences to KB based on new knowledge
    ...
    def make_random_move(self):
        ...
        """
        allMoves = self.height * self.width
        if len(self.moves_made) == allMoves:
            return None
        ...
        while True:
            ...
            if (cell not in ltemp) and (cell not in self.moves_made) and (cell not in self.mines):
                return cell
            ltemp.append(cell)
